...
chroot "$CHROOT/$TARGET" /bin/sh -c "rm -f /usr/src/redhat/RPMS/i386/* /usr/src/redhat/SRPMS/* && cd /usr/src/redhat/SPECS && rpmbuild -ba barry.spec --with gui && cd /usr/src/redhat/RPMS/i386"
