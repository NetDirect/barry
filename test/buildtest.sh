...
#   po/ - unsure
#   publiccfg.h - this is an autogenerated header that gets installed
#                 by make install, and somehow sticks around after
#                 a 'make dist'... it is harmless, so ignore in the diff
#   Doxyfile - another autogenerated file
diff -ruN \
