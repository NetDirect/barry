barry (0.18.0-1) unstable; urgency=low
  ...
  * removed .la files (2011/07/05)
  * added orangeuk and mts ppp chatscript files (2011/08/08)
  * added bwatch
  * added btarcmp
  * made udev linux-only, as per intrigeri's patch 539ed1b43b5559b8a90f7b651
  ...
  * this release closes: #657076
  * moved bsyncjail to /usr/lib/barry/barrydesktop/
 ...
 -- Chris Frey <cdfrey@foursquare.net>  Sat, 23 Apr 2012 00:38:40 -0500

barry (0.13-1.2) unstable; urgency=low
 ...
 -- Jose Carlos Garcia Sogo <jsogo@debian.org>  Sun, 10 Aug 2008 20:17:34 +0200

barry (0.13-1.1) unstable; urgency=low

  * Non-maintainer upload.

 -- Jason Thomas <jason@debian.org>  Tue, 29 Apr 2008 17:28:34 +1000

barry (0.13-1) unstable; urgency=low

   * version bump

 -- Chris Frey <cdfrey@foursquare.net>  Fri, 21 Mar 2008 21:38:11 -0400
