...
<p>Fourth, it will be easy to create different sync targets so that data
(email, contacts, etc) can be synchronized with differ data sources
(Evolution, Thunderbird, etc.)
...
user's computer could stored in many different formats.  Email, contact,
...
<p>User Interface: Python is the choice for user interface, mainly because
it's the language used in so many admin tools for our favourite distro,
Red Hat.  </p>
