...
#define SB_COMMAND_JL_GET_DIR_ENTRY	0x6e		// FIXME: Maybe SB_COMMAND_JL_GET_ENTRY is cleaner
#define SB_COMMAND_JL_GET_SS_ENTRY	0x6e		// SS_ENTRY for Screen Shot Entry
